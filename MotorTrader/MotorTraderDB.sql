...
-- Cars Table (no longer tied to a specific user)
CREATE TABLE cars (
    id INT AUTO_INCREMENT PRIMARY KEY,
    make VARCHAR(100),
    model VARCHAR(100),
...
-- Insert cars (no user_id needed)
INSERT INTO cars (make, model, year, mileage, price, description, image)
VALUES
('Toyota', 'Corolla', 2018, 45000, 15000.00, 'Well-maintained, single owner, great condition.', 'toyota_corolla.jpg'),
('Honda', 'Civic', 2017, 60000, 14000.00, 'Sporty and fuel-efficient, clean interior.', 'honda_civic.jpg'),
('Ford', 'Focus', 2016, 55000, 12000.00, 'Compact car, runs smoothly, great for city driving.', 'ford_focus.jpg'),
('Chevrolet', 'Malibu', 2019, 30000, 18000.00, 'Spacious sedan, modern features, low mileage.', 'chevrolet_malibu.jpg'),
('BMW', '3 Series', 2015, 75000, 22000.00, 'Luxury sedan with leather interior, well maintained.', 'bmw_3series.jpg'),
('Nissan', 'Altima', 2020, 25000, 19000.00, 'Sleek design, fuel-efficient, advanced safety features.', 'nissan_altima.jpg'),
('Hyundai', 'Elantra', 2019, 40000, 16000.00, 'Comfortable ride, modern tech, excellent value.', 'hyundai_elantra.jpg'),
('Kia', 'Sorento', 2018, 35000, 21000.00, 'Spacious SUV, great for families, reliable performance.', 'kia_sorento.jpg'),
('Volkswagen', 'Golf', 2017, 50000, 13000.00, 'Compact and fun to drive, perfect for urban living.', 'volkswagen_golf.jpg'),
('Subaru', 'Outback', 2019, 30000, 24000.00, 'All-wheel drive, rugged yet comfortable, ideal for adventures.', 'subaru_outback.jpg'),
('Mazda', 'CX-5', 2020, 20000, 25000.00, 'Stylish crossover, excellent handling, premium interior.', 'mazda_cx5.jpg'),
('Audi', 'A4', 2018, 45000, 28000.00, 'Luxury sedan with cutting-edge technology, smooth ride.', 'audi_a4.jpg'),
('Jeep', 'Wrangler', 2017, 40000, 27000.00, 'Iconic off-road vehicle, rugged and versatile.', 'jeep_wrangler.jpg'),
('Tesla', 'Model 3', 2021, 15000, 45000.00, 'Electric car, fast acceleration, autopilot features.', 'tesla_model3.jpg'),
('Lexus', 'RX 350', 2019, 30000, 38000.00, 'Luxury SUV, quiet cabin, smooth and powerful ride.', 'lexus_rx350.jpg');
